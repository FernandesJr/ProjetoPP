...
<body class="bg-gradient-primary">
									...
									<form class="user" action="ControllerLogin" method="post">
										...
										<div class="form-group">
											<div class="custom-control custom-checkbox small">
												<input type="checkbox" class="custom-control-input check-senha"
													id="customCheck" onclick="mostrarsenha()">
												<label
													class="custom-control-label" for="customCheck">Mostrar senha
												</label>
											</div>
										</div>
	...
	<footer class="footer-pri">
		<p class="text-center">
			...
			&copy; <a href="#" target="">DiogoBarros</a> &copy; <a href="#"
